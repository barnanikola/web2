...
namespace WebApp.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        [Route("GetUser")]
        public GetUserBindingModel GetUser()
        {
            ApplicationUser user = UserManager.FindByName(Request.GetOwinContext().Authentication.User.Identity.Name);
            return new GetUserBindingModel(user);
        }

        [Route("GetUsers")]
        public IEnumerable<GetUserBindingModel> GetUsers()
        {
            List<ApplicationUser> users = new List<ApplicationUser>(UserManager.Users);
            List<GetUserBindingModel> bindingUsers = new List<GetUserBindingModel>();

            foreach (var user in users)
            {
                bindingUsers.Add(new GetUserBindingModel(user));
            }
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new ApplicationUser() {
                ...
                DatRodj = model.DatRodj,
                Adresa = model.Adresa,
                TipKorisnika = model.TipKorisnika,
                VrstaNaloga = "Korisnik",
                Url = model.Url,
                Status = "zahtev se procesira"
            };
        ...
        [Route("GetImageEmail")]
        public HttpResponseMessage GetImageEmail(string email)
        {
        ...
        private void SendEmail(ChangeStatusBindingModel data)
        {
            try
            {
                var fromAddress = new MailAddress("web2nikola@gmail.com", "WEB2 APP");
                var toAddress = new MailAddress("nikola.21.barna@gmail.com");
                string fromPassword = "web2pass";
